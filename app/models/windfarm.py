from sqlalchemy import Column, Integer, String, Text, DateTime, Date, Float, Boolean, ForeignKey, DECIMAL
...
class Windfarm(Base):
    ...
    status = Column(String(100), nullable=True)  # "operational" | "decommissioned" | "under_installation"
