...
def upgrade() -> None:
    ...
    op.create_table('windfarms',
        ...
        sa.ForeignKeyConstraint(['control_area_id'], ['control_areas.id'], ),
        sa.ForeignKeyConstraint(['country_id'], ['countries.id'], ),
        sa.ForeignKeyConstraint(['market_balance_area_id'], ['market_balance_areas.id'], ),
    ...
    op.create_table('turbine_units',
        ...
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['turbine_model_id'], ['turbine_models.id'], ),
