...
CONTROL_AREAS_DATA = [
    ...
    {"code": "10YCZ-CEPS-----N", "name": "CZ", "acronym": "CZ", "country_name": "Czech Republic"},
    {
        "code": "10YDE-ENBW-----N",
        "name": "DE(TransnetBW)",
        "acronym": "DE(TransnetBW)",
        "country_name": "Germany",
    },
    {
        "code": "10YDE-EON------1",
        "name": "DE(TenneT GER)",
        "acronym": "DE(TenneT GER)",
        "country_name": "Germany",
    },
    {
        "code": "10YDE-RWENET---I",
    ...
    {
        "code": "10YDOM-1001A082L",
        "name": "PL-CZ",
        "acronym": "PL-CZ",
        "country_name": "Poland",
    },  # Cross-border, assigned to Poland
...
def seed_control_areas(db: Session):
    ...
    for ca_data in CONTROL_AREAS_DATA:
        ...
        if country_iso3 and country_iso3 in country_map:
            ...
            warnings.append(
                f"Country not found: {country_name} (ISO3: {country_iso3}) for control area {ca_data['name']}"
            )

        # Create control area
        control_area = ControlArea(
            code=ca_data["code"], name=ca_data["name"], country_id=country_id
        )
