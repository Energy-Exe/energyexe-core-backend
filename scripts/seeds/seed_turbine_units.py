...
TURBINE_UNITS_DATA = [
    {"windfarm_name": "Aberdeen", "turbine_model": "V164-8.0", "turbine_status": "operational", "units": 11},
    {"windfarm_name": "Albatros / Hohe See", "turbine_model": "SWT-7.0-154", "turbine_status": "operational", "units": 87},
    {"windfarm_name": "Alpha Ventus", "turbine_model": "AD5-116", "turbine_status": "operational", "units": 6},
    {"windfarm_name": "Alpha Ventus", "turbine_model": "REpower 5M", "turbine_status": "operational", "units": 6},
    {"windfarm_name": "Amrumbank West", "turbine_model": "SWT-3.6-120", "turbine_status": "operational", "units": 80},
    {"windfarm_name": "Anholt", "turbine_model": "SWT-3.6-120", "turbine_status": "operational", "units": 111},
    {"windfarm_name": "Arcadis Ost 1", "turbine_model": "V174-9.5", "turbine_status": "operational", "units": 27},
    {"windfarm_name": "Arkona", "turbine_model": "SWT-6.0-154", "turbine_status": "operational", "units": 60},
    {"windfarm_name": "Avedøre", "turbine_model": "SWT-3.6-120", "turbine_status": "operational", "units": 3},
    {"windfarm_name": "Baltic 1", "turbine_model": "SWT-2.3-93", "turbine_status": "operational", "units": 21},
    {"windfarm_name": "Baltic 2", "turbine_model": "SWT-3.6-120", "turbine_status": "operational", "units": 80},
    {"windfarm_name": "Baltic Eagle", "turbine_model": "V174-9.5", "turbine_status": "operational", "units": 50},
    {"windfarm_name": "Baltic Power", "turbine_model": "V236-15.0", "turbine_status": "under_installation", "units": 76},
    {"windfarm_name": "BARD Offshore 1", "turbine_model": "BARD 5.0", "turbine_status": "operational", "units": 80},
    {"windfarm_name": "Barrow", "turbine_model": "V90-3.0", "turbine_status": "operational", "units": 30},
    {"windfarm_name": "Beatrice", "turbine_model": "SWT-7.0-154", "turbine_status": "operational", "units": 84},
    {"windfarm_name": "Belwind 1", "turbine_model": "V90-3.0", "turbine_status": "operational", "units": 55},
    {"windfarm_name": "Belwind 1", "turbine_model": "Haliade 150-6", "turbine_status": "operational", "units": 1},
    {"windfarm_name": "Block Island", "turbine_model": "Haliade 150-6", "turbine_status": "operational", "units": 5},
    {"windfarm_name": "Borkum Riffgat", "turbine_model": "SWT-3.6-120", "turbine_status": "operational", "units": 30},
    {"windfarm_name": "Borkum Riffgrund 1", "turbine_model": "SWT-4.0-120", "turbine_status": "operational", "units": 78},
    {"windfarm_name": "Borkum Riffgrund 2", "turbine_model": "V164-8.0", "turbine_status": "operational", "units": 56},
]


def generate_turbine_unit_code(windfarm_code: str, turbine_model_code: str, unit_number: int) -> str:
    ...
    for unit_data in TURBINE_UNITS_DATA:
        ...
        for unit_num in range(1, unit_count + 1):
            try:
                ...
                code = generate_turbine_unit_code(
                    windfarm.code,
                    turbine_model.model,
                    unit_num
                )
                ...
                print(f"    ❌ Failed to add unit {unit_num} for {windfarm_name}/{turbine_model_name}: {error_msg}")
                db.rollback()
        
        if units_created > 0:
            print(f"    ✅ Added {units_created} units for {windfarm_name} with {turbine_model_name}")
