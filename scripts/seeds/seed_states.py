...
STATES_DATA = [
    ...
    {"code": "NC", "name": "North Carolina", "country_code": "USA", "lat": 35.7596, "lng": -79.0193},
    ...
    {"code": "SC", "name": "South Carolina", "country_code": "USA", "lat": 33.8191, "lng": -80.9066},
    ...
    {"code": "WA-US", "name": "Washington", "country_code": "USA", "lat": 47.7511, "lng": -120.7401},
    ...
    {"code": "BC", "name": "British Columbia", "country_code": "CAN", "lat": 53.7267, "lng": -127.6476},
    ...
    {"code": "NL", "name": "Newfoundland and Labrador", "country_code": "CAN", "lat": 53.1355, "lng": -57.6604},
    {"code": "NT-CA", "name": "Northwest Territories", "country_code": "CAN", "lat": 61.2181, "lng": -113.5170},
    ...
    {"code": "PE", "name": "Prince Edward Island", "country_code": "CAN", "lat": 46.5107, "lng": -63.4168},
    ...
    {"code": "BW", "name": "Baden-Württemberg", "country_code": "DEU", "lat": 48.6616, "lng": 9.3501},
    ...
    {"code": "MV", "name": "Mecklenburg-Western Pomerania", "country_code": "DEU", "lat": 53.6127, "lng": 12.4296},
    {"code": "NI", "name": "Lower Saxony", "country_code": "DEU", "lat": 52.6367, "lng": 9.8451},
    {"code": "NW", "name": "North Rhine-Westphalia", "country_code": "DEU", "lat": 51.4332, "lng": 7.6616},
    {"code": "RP", "name": "Rhineland-Palatinate", "country_code": "DEU", "lat": 49.9129, "lng": 7.4530},
    ...
    {"code": "SH", "name": "Schleswig-Holstein", "country_code": "DEU", "lat": 54.2194, "lng": 9.6961},
    ...
    {"code": "NIR", "name": "Northern Ireland", "country_code": "GBR", "lat": 54.7877, "lng": -6.4923},
    
    # Australian States
    {"code": "NSW", "name": "New South Wales", "country_code": "AUS", "lat": -31.2532, "lng": 146.9211},
    {"code": "QLD", "name": "Queensland", "country_code": "AUS", "lat": -20.9176, "lng": 142.7028},
    {"code": "SA", "name": "South Australia", "country_code": "AUS", "lat": -29.9756, "lng": 134.4213},
    ...
    {"code": "WA-AU", "name": "Western Australia", "country_code": "AUS", "lat": -25.2764, "lng": 121.2914},
    {"code": "ACT", "name": "Australian Capital Territory", "country_code": "AUS", "lat": -35.4735, "lng": 149.0124},
    {"code": "NT-AU", "name": "Northern Territory", "country_code": "AUS", "lat": -19.4914, "lng": 132.5510},
]
...
def seed_states(db: Session):
    ...
    for state_data in STATES_DATA:
        ...
        if country_code not in country_map:
            print(f"  Warning: Country {country_code} not found, skipping state {state_data['name']}")
            skipped += 1
            continue
